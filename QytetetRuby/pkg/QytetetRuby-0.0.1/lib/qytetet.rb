   ...
   def inicializar_juego(nombres)
    ...
    def aplicar_sorpresa
      ...
      if(@carta_actual.tipo == TipoSorpresa::SALIRCARCEL)
        @jugador_actual.carta_libertad = cartaActual
    ...
    c = @tablero.obtener_casilla_final(@jugador_actual.casilla_actual, @dado.valor)
    ...
    def mover(num_casilla_destino)
      ...
      if num_casilla_destino < casilla_inicial.num_casilla
